...
inline static void select_device_interactive(cl_platform_id *platforms,
                                             cl_uint *platformCount,
                                             cl_device_type *device_type) {
  unsigned valid = 0;
  char device_type_char[2];
  *device_type = (cl_device_type)8;
  /*
    fprintf(stderr,
    "============================================================"
                    "====================\n");
...
// Checks to see if environmental variable for choosing device type is set or
// not
inline static void select_device_type(cl_platform_id *platforms,
                                      cl_uint *platformCount,
                                      cl_device_type *device_type) {
  // char *dev_type_env = getenv("CL_DEVICE_TYPE");
  char *dev_type_env = getenv("CL_DEVICE_TYPE_ACCELERATOR");
  if (dev_type_env) {
...
inline static void display_error_message(cl_int errcode, FILE *out) {
  ...
  case CL_COMPILE_PROGRAM_FAILURE:
    fprintf(out, "CL_COMPILE_PROGRAM_FAILURE.\n");
    break;
  case CL_LINKER_NOT_AVAILABLE:
    fprintf(out, "CL_LINKER_NOT_AVAILABLE.\n");
    break;
  case CL_LINK_PROGRAM_FAILURE:
    fprintf(out, "CL_LINK_PROGRAM_FAILURE.\n");
    break;
  case CL_DEVICE_PARTITION_FAILED:
    fprintf(out, "CL_DEVICE_PARTITION_FAILED.\n");
    break;
  case CL_KERNEL_ARG_INFO_NOT_AVAILABLE:
    fprintf(out, "CL_KERNEL_ARG_INFO_NOT_AVAILABLE.\n");
    break;
#endif
  ...
  case CL_INVALID_PROPERTY:
    fprintf(out, "CL_INVALID_PROPERTY.\n");
    break;
  case CL_INVALID_IMAGE_DESCRIPTOR:
    fprintf(out, "CL_INVALID_IMAGE_DESCRIPTOR.\n");
    break;
  case CL_INVALID_COMPILER_OPTIONS:
    fprintf(out, "CL_INVALID_COMPILER_OPTIONS.\n");
    break;
  case CL_INVALID_LINKER_OPTIONS:
    fprintf(out, "CL_INVALID_LINKER_OPTIONS.\n");
    break;
  case CL_INVALID_DEVICE_PARTITION_COUNT:
    fprintf(out, "CL_INVALID_DEVICE_PARTITION_COUNT.\n");
    break;
  case CL_INVALID_PIPE_SIZE:
    fprintf(out, "CL_INVALID_PIPE_SIZE.\n");
    break;
  case CL_INVALID_DEVICE_QUEUE:
    fprintf(out, "CL_INVALID_DEVICE_QUEUE.\n");
    break;
#endif

    /*// DirectX and GL error codes
    case CL_INVALID_GL_SHAREGROUP_REFERENCE_KHR	: fprintf(out,
    "CL_INVALID_GL_SHAREGROUP_REFERENCE_KHR.\n"); break; case
    CL_PLATFORM_NOT_FOUND_KHR			: fprintf(out,
    "CL_PLATFORM_NOT_FOUND_KHR.\n"); break; case CL_INVALID_D3D10_DEVICE_KHR
    : fprintf(out, "CL_INVALID_D3D10_DEVICE_KHR.\n"); break; case
    CL_INVALID_D3D10_RESOURCE_KHR		: fprintf(out,
    "CL_INVALID_D3D10_RESOURCE_KHR.\n"); break; case
    CL_D3D10_RESOURCE_ALREADY_ACQUIRED_KHR	: fprintf(out,
    "CL_D3D10_RESOURCE_ALREADY_ACQUIRED_KHR.\n"); break; case
    CL_D3D10_RESOURCE_NOT_ACQUIRED_KHR		: fprintf(out,
    "CL_D3D10_RESOURCE_NOT_ACQUIRED_KHR.\n"); break; case
    CL_INVALID_D3D11_DEVICE_KHR		: fprintf(out,
    "CL_INVALID_D3D11_DEVICE_KHR.\n"); break; case CL_INVALID_D3D11_RESOURCE_KHR
    : fprintf(out, "CL_INVALID_D3D11_RESOURCE_KHR.\n"); break; case
    CL_D3D11_RESOURCE_ALREADY_ACQUIRED_KHR	: fprintf(out,
    "CL_D3D11_RESOURCE_ALREADY_ACQUIRED_KHR.\n"); break; case
    CL_D3D11_RESOURCE_NOT_ACQUIRED_KHR 	: fprintf(out,
    "CL_D3D11_RESOURCE_NOT_ACQUIRED_KHR .\n"); break; case
    CL_INVALID_DX9_MEDIA_ADAPTER_KHR		: fprintf(out,
    "CL_INVALID_DX9_MEDIA_ADAPTER_KHR.\n"); break; case
    CL_INVALID_DX9_MEDIA_SURFACE_KHR		: fprintf(out,
    "CL_INVALID_DX9_MEDIA_SURFACE_KHR.\n"); break; case
    CL_DX9_MEDIA_SURFACE_ALREADY_ACQUIRED_KHR	: fprintf(out,
    "CL_DX9_MEDIA_SURFACE_ALREADY_ACQUIRED_KHR.\n"); break; case
    CL_DX9_MEDIA_SURFACE_NOT_ACQUIRED_KHR	: fprintf(out,
...
inline static int is_ndrange_kernel(int version) { return (version % 2) == 0; }
