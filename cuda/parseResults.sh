  ...
  do
    ...
    do
        cat ${work}_${str}_iter-${i}_idd-*_conc-${concurrency}.csv | grep "Elapsed" | \
            awk '{print $3}' >> ../elapsed_merged_${work}_${str}_conc-${concurrency}_${i}.out
        cat ${work}_${str}_iter-${i}_idd-*_conc-${concurrency}.csv | grep "Init" | \
            awk '{print $3}' >> ../init_merged_${work}_${str}_conc-${concurrency}_${i}.out
        ...
        cat ${work}_${str}_iter-${i}_idd-*_conc-${concurrency}.csv | grep "Warmup" | \
            awk '{print $3}' >> ../warmup_merged_${work}_${str}_conc-${concurrency}_${i}.out
...
do
    ...
    then
      echo "Gaussian"
      workloads=("256" "512" "1024" "2048" "4096" "8192")
      parser ${workloads} ${iterations} ${concurrency}
    elif [[ "$str" == "hotspot" ]]
    then 
      echo "Hotspot"
