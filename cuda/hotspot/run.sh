...
if [[ "$PROFILING" == "1" ]]; then
    ...
    nsys profile --trace=cuda --cuda-event-trace=false --sample=none --output ${report} ./${benchmark_name} 1024 4000 1000000 ../../data/hotspot/temp_1024 ../../data/hotspot/power_1024 result.txt
