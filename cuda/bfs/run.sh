...
if [[ "$PROFILING" == "1" ]]; then
    ...
    nsys profile --trace=cuda --sample=none --output ${report} ./${benchmark_name} ../../data/bfs/graph65536.txt
    ...
    for ((iter=1; iter<=30;iter++)); do ./${benchmark_name} ../../data/bfs/graph65536.txt &>65536_${iter}_${file}; done
