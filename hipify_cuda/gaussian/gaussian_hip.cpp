...
void ForwardSub() {
  ...
  // copy memory to GPU
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(m_cuda, m, Size * Size * sizeof(float), hipMemcpyHostToDevice));
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(a_cuda, a, Size * Size * sizeof(float), hipMemcpyHostToDevice));
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(b_cuda, b, Size * sizeof(float), hipMemcpyHostToDevice));
  ...
  CUDA_ERROR_FATAL_RUNTIME(hipDeviceSynchronize());
#ifdef BREAKDOWNS
  hipDeviceSynchronize();
  ...
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(m, m_cuda, Size * Size * sizeof(float), hipMemcpyDeviceToHost));
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(a, a_cuda, Size * Size * sizeof(float), hipMemcpyDeviceToHost));
  CUDA_ERROR_FATAL_RUNTIME(hipMemcpy(b, b_cuda, Size * sizeof(float), hipMemcpyDeviceToHost));
#ifdef BREAKDOWNS
