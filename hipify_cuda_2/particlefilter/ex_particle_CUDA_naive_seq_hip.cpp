...
void particleFilter(int * I, int IszX, int IszY, int Nfr, int * seed, int Nparticles){
	...
	for(k = 1; k < Nfr; k++){
		...
		HIP_CHECK(hipMemcpy(arrayX_GPU, arrayX, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		HIP_CHECK(hipMemcpy(arrayY_GPU, arrayY, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		HIP_CHECK(hipMemcpy(xj_GPU, xj, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		HIP_CHECK(hipMemcpy(yj_GPU, yj, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		HIP_CHECK(hipMemcpy(CDF_GPU, CDF, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		HIP_CHECK(hipMemcpy(u_GPU, u, sizeof(double)*Nparticles, hipMemcpyHostToDevice));
		...
		HIP_CHECK(hipMemcpy(yj, yj_GPU, sizeof(double)*Nparticles, hipMemcpyDeviceToHost));
		HIP_CHECK(hipMemcpy(xj, xj_GPU, sizeof(double)*Nparticles, hipMemcpyDeviceToHost));
