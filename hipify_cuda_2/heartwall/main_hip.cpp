...
int main(int argc, char *argv[]) {
  ...
  common.endoRow[0] = 369;  common.endoRow[1] = 400;  common.endoRow[2] = 429;  common.endoRow[3] = 452;
  common.endoRow[4] = 476;  common.endoRow[5] = 486;  common.endoRow[6] = 479;  common.endoRow[7] = 458;
  common.endoRow[8] = 433;  common.endoRow[9] = 404;  common.endoRow[10] = 374; common.endoRow[11] = 346;
  common.endoRow[12] = 318; common.endoRow[13] = 294; common.endoRow[14] = 277; common.endoRow[15] = 269;
  common.endoRow[16] = 275; common.endoRow[17] = 287; common.endoRow[18] = 311; common.endoRow[19] = 339;

  common.endoCol[0] = 408;  common.endoCol[1] = 406;  common.endoCol[2] = 397;  common.endoCol[3] = 383;
  common.endoCol[4] = 354;  common.endoCol[5] = 322;  common.endoCol[6] = 294;  common.endoCol[7] = 270;
  common.endoCol[8] = 250;  common.endoCol[9] = 237;  common.endoCol[10] = 235; common.endoCol[11] = 241;
  common.endoCol[12] = 254; common.endoCol[13] = 273; common.endoCol[14] = 300; common.endoCol[15] = 328;
  common.endoCol[16] = 356; common.endoCol[17] = 383; common.endoCol[18] = 401; common.endoCol[19] = 411;
  ...
  common.epiRow[0] = 390; common.epiRow[1] = 419; common.epiRow[2] = 448; common.epiRow[3] = 474;
  common.epiRow[4] = 501; common.epiRow[5] = 519; common.epiRow[6] = 535; common.epiRow[7] = 542;
  common.epiRow[8] = 543; common.epiRow[9] = 538; common.epiRow[10] = 528; common.epiRow[11] = 511;
  common.epiRow[12] = 491; common.epiRow[13] = 466; common.epiRow[14] = 438; common.epiRow[15] = 406;
  common.epiRow[16] = 376; common.epiRow[17] = 347; common.epiRow[18] = 318; common.epiRow[19] = 291;
  common.epiRow[20] = 275; common.epiRow[21] = 259; common.epiRow[22] = 256; common.epiRow[23] = 252;
  common.epiRow[24] = 252; common.epiRow[25] = 257; common.epiRow[26] = 266; common.epiRow[27] = 283;
  common.epiRow[28] = 305; common.epiRow[29] = 331; common.epiRow[30] = 360;

  common.epiCol[0] = 457; common.epiCol[1] = 454; common.epiCol[2] = 446; common.epiCol[3] = 431;
  common.epiCol[4] = 411; common.epiCol[5] = 388; common.epiCol[6] = 361; common.epiCol[7] = 331;
  common.epiCol[8] = 301; common.epiCol[9] = 273; common.epiCol[10] = 243; common.epiCol[11] = 218;
  common.epiCol[12] = 196; common.epiCol[13] = 178; common.epiCol[14] = 166; common.epiCol[15] = 157;
  common.epiCol[16] = 155; common.epiCol[17] = 165; common.epiCol[18] = 177; common.epiCol[19] = 197;
  common.epiCol[20] = 218; common.epiCol[21] = 248; common.epiCol[22] = 276; common.epiCol[23] = 304;
  common.epiCol[24] = 333; common.epiCol[25] = 361; common.epiCol[26] = 391; common.epiCol[27] = 415;
  common.epiCol[28] = 434; common.epiCol[29] = 448; common.epiCol[30] = 455;
  ...
  // ---- ALLOCATION BLOCK (match CUDA structure) ----
  HIP_CHECK(hipMalloc((void **)&common_change.d_frame, common.frame_mem));
  HIP_CHECK(hipMalloc((void **)&common.d_endoRow, common.endo_mem));
  HIP_CHECK(hipMalloc((void **)&common.d_endoCol, common.endo_mem));
  HIP_CHECK(hipMalloc((void **)&common.d_tEndoRowLoc, common.endo_mem * common.no_frames));
  HIP_CHECK(hipMalloc((void **)&common.d_tEndoColLoc, common.endo_mem * common.no_frames));
  HIP_CHECK(hipMalloc((void **)&common.d_epiRow, common.epi_mem));
  HIP_CHECK(hipMalloc((void **)&common.d_epiCol, common.epi_mem));
  HIP_CHECK(hipMalloc((void **)&common.d_tEpiRowLoc, common.epi_mem * common.no_frames));
  HIP_CHECK(hipMalloc((void **)&common.d_tEpiColLoc, common.epi_mem * common.no_frames));
  HIP_CHECK(hipMalloc((void **)&common.d_endoT, common.in_mem * common.endoPoints));
  HIP_CHECK(hipMalloc((void **)&common.d_epiT, common.in_mem * common.epiPoints));

  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2, common.in2_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_conv, common.conv_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_pad_cumv, common.in2_pad_cumv_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_pad_cumv_sel, common.in2_pad_cumv_sel_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_sub_cumh, common.in2_sub_cumh_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_sub_cumh_sel, common.in2_sub_cumh_sel_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_sub2, common.in2_sub2_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_sqr, common.in2_sqr_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in2_sqr_sub2, common.in2_sqr_sub2_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_in_sqr, common.in_sqr_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_tMask, common.tMask_mem));
  for (i = 0; i < common.allPoints; i++) HIP_CHECK(hipMalloc((void **)&unique[i].d_mask_conv, common.mask_conv_mem));

  // wire unique[] pointers (same as CUDA)
  ...
  // ---- H2D + ToSymbol block (match CUDA) ----
  HIP_CHECK(hipMemcpy(common.d_endoRow, common.endoRow, common.endo_mem, hipMemcpyHostToDevice));
  HIP_CHECK(hipMemcpy(common.d_endoCol, common.endoCol, common.endo_mem, hipMemcpyHostToDevice));
  HIP_CHECK(hipMemcpy(common.d_epiRow, common.epiRow, common.epi_mem, hipMemcpyHostToDevice));
  HIP_CHECK(hipMemcpy(common.d_epiCol, common.epiCol, common.epi_mem, hipMemcpyHostToDevice));
  HIP_CHECK(hipMemcpyToSymbol(HIP_SYMBOL(d_common), &common, sizeof(params_common)));
  HIP_CHECK(hipMemcpyToSymbol(HIP_SYMBOL(d_unique), &unique, sizeof(params_unique) * ALL_POINTS));
  ...
  // ---- main processing loop (same structure) ----
  for (common_change.frame_no = 0; common_change.frame_no < frames_processed;
    ...
    HIP_CHECK(hipMemcpy(common_change.d_frame, frame, common.frame_mem, hipMemcpyHostToDevice));
    HIP_CHECK(hipMemcpyToSymbol(HIP_SYMBOL(d_common_change), &common_change, sizeof(params_common_change)));
  ...
  // ---- D2H (same) ----
  HIP_CHECK(hipMemcpy(common.tEndoRowLoc, common.d_tEndoRowLoc,
                      common.endo_mem * common.no_frames, hipMemcpyDeviceToHost));
  HIP_CHECK(hipMemcpy(common.tEndoColLoc, common.d_tEndoColLoc,
                      common.endo_mem * common.no_frames, hipMemcpyDeviceToHost));
  HIP_CHECK(hipMemcpy(common.tEpiRowLoc, common.d_tEpiRowLoc,
                      common.epi_mem * common.no_frames, hipMemcpyDeviceToHost));
  HIP_CHECK(hipMemcpy(common.tEpiColLoc, common.d_tEpiColLoc,
                      common.epi_mem * common.no_frames, hipMemcpyDeviceToHost));
  ...
  // ---- Free (same) ----
  HIP_CHECK(hipFree(common_change.d_frame));
  HIP_CHECK(hipFree(common.d_endoRow));
  HIP_CHECK(hipFree(common.d_endoCol));
  HIP_CHECK(hipFree(common.d_tEndoRowLoc));
  HIP_CHECK(hipFree(common.d_tEndoColLoc));
  HIP_CHECK(hipFree(common.d_endoT));
  HIP_CHECK(hipFree(common.d_epiRow));
  HIP_CHECK(hipFree(common.d_epiCol));
  HIP_CHECK(hipFree(common.d_tEpiRowLoc));
  HIP_CHECK(hipFree(common.d_tEpiColLoc));
  HIP_CHECK(hipFree(common.d_epiT));

  for (i = 0; i < common.allPoints; i++) {
    HIP_CHECK(hipFree(unique[i].d_in2));
    HIP_CHECK(hipFree(unique[i].d_conv));
    HIP_CHECK(hipFree(unique[i].d_in2_pad_cumv));
    HIP_CHECK(hipFree(unique[i].d_in2_pad_cumv_sel));
    HIP_CHECK(hipFree(unique[i].d_in2_sub_cumh));
    HIP_CHECK(hipFree(unique[i].d_in2_sub_cumh_sel));
    HIP_CHECK(hipFree(unique[i].d_in2_sub2));
    HIP_CHECK(hipFree(unique[i].d_in2_sqr));
    HIP_CHECK(hipFree(unique[i].d_in2_sqr_sub2));
    HIP_CHECK(hipFree(unique[i].d_in_sqr));
    HIP_CHECK(hipFree(unique[i].d_tMask));
    HIP_CHECK(hipFree(unique[i].d_mask_conv));
  }
